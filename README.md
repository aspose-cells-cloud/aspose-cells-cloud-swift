...
First, create an account at [Aspose for Cloud](https://dashboard.aspose.cloud/#/apps) and get your application information. Then, add pod `'AsposeCellsCloud', '~> 21.7'` similar to the following:
