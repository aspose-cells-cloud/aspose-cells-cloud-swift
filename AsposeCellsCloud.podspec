#
#  Be sure to run `pod spec lint AsposeCellsCloud.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/aspose-cells-cloud/aspose-cells-cloud-swift.git', :tag => s.version.to_s }
  ...
  s.source_files  = "AsposeCellsCloud/*.swift", "AsposeCellsCloud/**/*.swift"
