...
public struct ChartFrame: Codable {
...
public enum CodingKeys: String, CodingKey { 
    ...
    public init(link: Link?, isInnerMode: Bool?, shapeProperties: [LinkElement]?, autoScaleFont: Bool?, area: Area?, height: Int32?, width: Int32?, backgroundMode: String?, isAutomaticSize: Bool?, Y: Int32?, X: Int32?, shadow: Bool?, font: Font?, border: Line?) {
        self.link = link
