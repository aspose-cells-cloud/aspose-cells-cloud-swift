...
public struct Title: Codable {
    ...
    public var linkedSource: String?
...
public enum CodingKeys: String, CodingKey { 
        ...
        case border = "Border"
        case link = "link"
        case linkedSource = "LinkedSource"
        case text = "Text"
    ...
    public init(isInnerMode: Bool?, shapeProperties: [LinkElement]?, autoScaleFont: Bool?, area: Area?, height: Int32?, width: Int32?, backgroundMode: String?, isAutomaticSize: Bool?, Y: Int32?, X: Int32?, shadow: Bool?, font: Font?, border: Line?, link: Link?, linkedSource: String?, text: String?, isVisible: Bool?, textDirection: String?, rotationAngle: Int32?, textVerticalAlignment: String?, textHorizontalAlignment: String?) {
