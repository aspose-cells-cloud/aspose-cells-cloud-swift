...
class CellsAutoFilterAPITests: AsposeCellsCloudTests {
	...
	func testcellsAutoFilterDeleteWorksheetDateFilter() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterDeleteWorksheetDateFilter(name: name, sheetName: sheetName, fieldIndex: fieldIndex, dateTimeGroupingType: dateTimeGroupingType, year: year, month: month, day: day, hour: hour, minute: minute, second: second, folder: folder, storage: storage)
			{
				(response, error) in
	...
	func testcellsAutoFilterDeleteWorksheetFilter() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterDeleteWorksheetFilter(name: name, sheetName: sheetName, fieldIndex: fieldIndex, criteria: criteria, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterGetWorksheetAutoFilter() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterGetWorksheetAutoFilter(name: name, sheetName: sheetName, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPostWorksheetAutoFilterRefresh() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPostWorksheetAutoFilterRefresh(name: name, sheetName: sheetName, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPostWorksheetMatchBlanks() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPostWorksheetMatchBlanks(name: name, sheetName: sheetName, fieldIndex: fieldIndex, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPostWorksheetMatchNonBlanks() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPostWorksheetMatchNonBlanks(name: name, sheetName: sheetName, fieldIndex: fieldIndex, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPutWorksheetColorFilter() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPutWorksheetColorFilter(name: name, sheetName: sheetName, range: range, fieldIndex: fieldIndex, colorFilter: colorFilter, matchBlanks: matchBlanks, refresh: refresh, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPutWorksheetCustomFilter() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPutWorksheetCustomFilter(name: name, sheetName: sheetName, range: range, fieldIndex: fieldIndex, operatorType1: operatorType1, criteria1: criteria1, isAnd: isAnd, operatorType2: operatorType2, criteria2: criteria2, matchBlanks: matchBlanks, refresh: refresh, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPutWorksheetDateFilter() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPutWorksheetDateFilter(name: name, sheetName: sheetName, range: range, fieldIndex: fieldIndex, dateTimeGroupingType: dateTimeGroupingType, year: year, month: month, day: day, hour: hour, minute: minute, second: second, matchBlanks: matchBlanks, refresh: refresh, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPutWorksheetDynamicFilter() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPutWorksheetDynamicFilter(name: name, sheetName: sheetName, range: range, fieldIndex: fieldIndex, dynamicFilterType: dynamicFilterType, matchBlanks: matchBlanks, refresh: refresh, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPutWorksheetFilter() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPutWorksheetFilter(name: name, sheetName: sheetName, range: range, fieldIndex: fieldIndex, criteria: criteria, matchBlanks: matchBlanks, refresh: refresh, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPutWorksheetFilterTop10() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPutWorksheetFilterTop10(name: name, sheetName: sheetName, range: range, fieldIndex: fieldIndex, isTop: isTop, isPercent: isPercent, itemCount: itemCount, matchBlanks: matchBlanks, refresh: refresh, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
	...
	func testcellsAutoFilterPutWorksheetIconFilter() 
	{
		...
		uploadFile(name: name) {
			CellsAutoFilterAPI.cellsAutoFilterPutWorksheetIconFilter(name: name, sheetName: sheetName, range: range, fieldIndex: fieldIndex, iconSetType: iconSetType, iconId: iconId, matchBlanks: matchBlanks, refresh: refresh, folder: folder, storage: storage)
			{
				(response, error) in
				guard error == nil else {
